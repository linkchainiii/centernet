...
def top_pool(inputs):
    ...
    x = layers.Lambda(lambda x: tf.nn.max_pool(x, (1, h, 1, 1), (1, 1, 1, 1), padding="VALID"))(x)
...
def left_pool(inputs):
    ...
    x = layers.Lambda(lambda x:tf.nn.max_pool(x, (1, 1, w, 1), (1, 1, 1, 1), padding="VALID"))(x)
...
def bottom_pool(inputs):
    ...
    out = layers.Lambda(lambda x: tf.nn.max_pool(x, (1, h, 1, 1), (1, 1, 1, 1), padding="VALID"))(x)
    return out
...
def right_pool(inputs):
    ...
    out = layers.Lambda(lambda x: tf.nn.max_pool(x, (1, 1, w, 1), (1, 1, 1, 1), padding="VALID"))(x)
    return out
